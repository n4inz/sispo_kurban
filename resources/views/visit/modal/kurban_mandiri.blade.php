<div class="hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center md:inset-0 h-modal sm:h-full" id="kurban-mandiri">
    <div class="relative px-4 w-full max-w-7xl h-full md:h-auto">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex justify-between items-center p-5 rounded-t border-b dark:border-gray-600">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="kurban-mandiri">
            ...
            <form action="{{ route('visit_letter.index') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="flex-1 px-3">
                    ...
                    <div class="mb-6">
                        <label for="kecamatan"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Kecamatan</label>
                        <select id="kecamatan" name="kecamatan"
                            ...
                            <option value="Ujung">
                                Kec. Ujung</option>
                            <option value="Bacukiki">
                                Kec. Bacukiki</option>
                            <option value="Bacukiki barat">
                                Kec. Bacukiki barat</option>
                        </select>
                    </div>
            ...
            <div class="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                ...
                <button data-modal-toggle="kurban-mandiri" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600">Batal</button>
            </div>
        </form>
        </div>
    </div>
