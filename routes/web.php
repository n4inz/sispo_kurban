...
use App\Http\Controllers\Paket\PaketKurbanController;
...
Route::group(['middleware' => ['auth', 'role:ADMIN,EMPLOYEE,HEADMASTER,STUDENT']], function () {
    ...
    Route::group(['middleware' => ['auth', 'role:ADMIN,STUDENT']], function () {
        ...
        Route::prefix('student')->name('student.')->group(function () {
            ...
            Route::get('/pembayaran', [StudentAffairStudentController::class, 'konfirmasiPembayaran'])->name('pembayaran');
            Route::post('/pembayaran', [StudentAffairStudentController::class, 'upload_resi'])->name('upload_resi');
    ...
    Route::group(['middleware' => ['auth', 'role:ADMIN,EMPLOYEE,HEADMASTER']], function () {
        ...
        Route::prefix('employee')->name('employee.')->group(function () {
            ...
            Route::patch('/database/users', [EmployeeAffair\EmployeeController::class, 'delete_keuangan']);
            Route::group(['middleware' => ['auth', 'role:ADMIN']], function () {
        ...
        Route::prefix('paket')->name('paket.')->group(function () {
            Route::get('/', [PaketKurbanController::class, 'index'])->name('kurban');
            Route::post('/', [Visit\VisitLetterController::class, 'create'])->name('create');
